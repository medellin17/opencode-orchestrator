...
def main():
    ...
    agent_map = {
        ...
        "architecture-update": ["architect-planner", "architect-planner-pro"],
        "dependency-auditor": ["architect-planner", "architect-planner-pro", "researcher-explorer"],
        ...
        "plan-creator": ["architect-planner", "architect-planner-pro", "researcher-explorer"],
        "plan-reviewer": ["reviewer-critic", "architect-planner", "architect-planner-pro"],
        "plan-refiner": ["architect-planner", "architect-planner-pro"],
        "peer-reviewer": ["reviewer-critic"],
        "feature-implementer": ["implementer-builder"],
        "test-generator": ["test-engineer"],
        "debug-analyzer": ["debug"],
        "context-search": ["researcher-explorer", "architect-planner", "architect-planner-pro"],
        ...
        "vercel-react-best-practices": ["architect-planner", "architect-planner-pro", "reviewer-critic"],
        "web-design-guidelines": ["ux-designer", "reviewer-critic"],
        "brand-guidelines": ["ux-designer", "content-writer"],
        "canvas-design": ["ux-designer"],
        "discovery-interview": ["architect-planner", "architect-planner-pro"],
        ...
        "ralph": ["architect-planner", "architect-planner-pro"],
        "prd": ["architect-planner", "architect-planner-pro"],
