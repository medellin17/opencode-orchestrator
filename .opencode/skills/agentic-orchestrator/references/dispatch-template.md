...
### GOOD (pro planner dispatch with Context Brief):

Use `architect-planner-pro` only for complex or high-stakes plans. You MUST curate
the context yourself — do not dump raw research output.
